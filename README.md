...
Для начала создаём проект Приложение WPF (.NET Framework). Пока создаётся проект открываем Microsoft SQL Management (далее MSL) (можно найти через пуск в папке Microsoft SQL Server Tools 2022) и подключаемся к серверу, ничего вручную вводить не надо. Вы нажимаете подключиться. Затем переходите в свойства, это вам пригодится потом
...
Если у вас всё на английском ищите Test. Справа будут Средства
В качестве источника данных оставляем Microsoft SQL Server. В MSL 
